...
async def init():
    ...
    LOGGER("ANNIEMUSIC.plugins").info("Penguin's ᴍᴏᴅᴜʟᴇs ʟᴏᴀᴅᴇᴅ...")
    await userbot.start()
    await JARVIS.start()
    try:
        await JARVIS.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
    except NoActiveGroupCall:
        LOGGER("penguin_logs").error(
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("penguin_logs").info("sᴛᴏᴘɪɴɢ Pᴇnguin ᴍᴜsɪᴄ ʙᴏᴛ ...")
